...
export default function Login() {
  ...
  const [password, setPassword] = useState('splitmate123');
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 p-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Log in to see your balances.</p>

          <div className="mt-4 rounded-xl bg-indigo-50 text-indigo-700 text-xs px-3.5 py-2.5">
            Demo account: <span className="font-semibold">demo@splitmate.app</span> / <span className="font-semibold">splitmate123</span>
          </div>
          ...
          <p className="text-sm text-slate-500 text-center mt-6">
            New to SplitMate? <Link to="/signup" className="text-indigo-600 font-medium hover:underline">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
